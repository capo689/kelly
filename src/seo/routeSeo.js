...
const baseRoutes = [
  ['/', 'Central Oregon & Oregon Coast Real Estate | Kelly Miller', 'Explore Central Oregon and Central Oregon Coast real estate with Kelly Miller, an Oregon REALTOR®/Broker connecting the Cascades and the coast.', '/media/IMG_1895.webp'],
  ...
  ['/about-me', 'About Kelly Miller, Oregon REALTOR®/Broker', 'Meet Kelly Miller, a native Oregonian helping clients navigate homes, communities, and lifestyles from the Cascades to the Central Oregon Coast.', '/media/KellyM-PhotosxKristin-1.webp'],
  ...
  ['/blog', 'Central Oregon & Oregon Coast Real Estate Journal', 'Local guides and practical real estate answers for Central Oregon, the Central Oregon Coast, second homes, and life between the mountains and ocean.', '/media/IMG_1089.webp'],
